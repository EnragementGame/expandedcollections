package com.enragementgame.expandedcollections;
...
@Mod(ExpandedCollections.MODID)
public class ExpandedCollections
{
    public static final String MODID = "expandedcollections";
    private static final Logger LOGGER = LogUtils.getLogger();

    public ExpandedCollections(IEventBus modEventBus, ModContainer modContainer)
    {
        ...
        ExpandedVillagers.register(modEventBus);
